...
class MockResultSet implements ResultSet {
    ...
    public void pushResult(Map<String, Object> result) {
    ...
    public int getInt(String string) throws SQLException {
        return (Integer) result.get(string);
    }
    ...
    public Object getObject(String string) throws SQLException {
        return (Object) result.get(string);
    }
     ...
     * @return the results
     */
    public Stack<Map<String, Object>> getResults() {
        return results;
    }
     ...
     */
    public void setResults(Stack<Map<String, Object>> results) {
